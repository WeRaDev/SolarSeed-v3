...
>
> **APPROVAL SYSTEM**: Agent shell_exec actions require Admin approval via Cityview (Approval Quests).
> This is a security feature, not a limitation. Do not disable approvals. See WARP.md Section 6.
...
| **Customs** | authentik | `ghcr.io/goauthentik/server:2024.12` | Identity & Access Management (DIDroom/Authentik) | 9000/9443 |
