...
## 10) Nextcloud AIO hardening and backup status (2026-07-25)
...
- Prometheus scrapes `nextcloud-aio-nextcloud-exporter:9205`; `col-prometheus` is attached to both `city-of-light` and `nextcloud-aio` Docker networks.
...
- Last recovery event: 2026-07-25; all AIO child containers restarted and verified healthy.
