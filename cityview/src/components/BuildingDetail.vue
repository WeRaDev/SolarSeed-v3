...
const panelHeight = computed(() =>
  (props.building.appUrl || props.building.requiresConnection) ? 100 : 82
)
...
.detail-title   { font-size: 13px; font-weight: 700; fill: var(--charcoal); }
.detail-desc    { font-size: 10px; fill: var(--charcoal-light); }
...
.detail-resource { font-size: 10px; fill: var(--charcoal-light); }
.open-link {
...
.open-link:hover { fill: var(--gold-secondary); }
.close-hint      { font-size: 14px; fill: var(--charcoal-light); }
.close-hint:hover { fill: var(--status-down); }
</style>
